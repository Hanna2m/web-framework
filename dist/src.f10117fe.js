...
exports.Model = Model;
},{}],"src/models/Attribures.ts":[function(require,module,exports) {
"use strict";
...
var Attribures_1 = require("./Attribures");
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attribures_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attribures":"src/models/Attribures.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
